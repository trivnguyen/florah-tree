...
def get_config():
    ...
    config.workdir = "/mnt/ceph/users/tnguyen/florah-tree/sc-sam/gureft90-nprog3-dt4-z15"
    config.name = "gru-gru-opt-ratio-dt2_6"
    config.box_name = 'gureft90'
    config.run_scsam = True  # enable/disable running SC-SAM after preparing

    # data configuration
    config.data_root = "/mnt/ceph/users/tnguyen/florah-tree/generated-datasets/testdata/nprog3/gureft90-nprog3-dt2_6-z15"
    config.data_name = "gru-gru-opt-ratio/halos.0.pkl"
    config.start_file = 0
