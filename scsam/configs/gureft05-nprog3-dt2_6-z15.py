...
def get_config():
    ...
    config.name = "gru-gru-opt-dt2_6"
    config.box_name = 'gureft05'
    config.run_scsam = True  # enable/disable running SC-SAM after preparing

    # data configuration
    config.data_root = "/mnt/ceph/users/tnguyen/florah-tree/generated-datasets/testdata/nprog3/gureft05-nprog3-dt2_6-z15"
    config.data_name = "gru-gru-opt/halos.0.pkl"
    config.start_file = 0
